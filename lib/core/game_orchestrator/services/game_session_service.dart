...
class GameSessionService {
  ...
  Future<GameSession> createSession({
    ...
    try {
      ...
      final response = await _client.from('game_sessions').insert({
        'room_id': roomId,
  ...
  Future<void> saveGameResult({
    ...
    try {
      // 1. Sauvegarder le résultat dans game_results
      ...
      // 2. Mettre à jour les scores globaux dans game_sessions
      ...
      debugPrint('✅ Résultat enregistré: ${result.gameType}');
    } catch (e) {
