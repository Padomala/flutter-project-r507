 ...
 */
  /**
   * Crée la ligne de données initiale complète
   * Si playerBId est fourni, les deux joueurs sont initialisés (mode orchestrateur)
   * Sinon, seul player_a_id est rempli et on attend player_b_id (mode standalone)
   */
